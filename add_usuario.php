    ...
    if (!empty($nome) && !empty($email) && !empty($senha)) {
        try {
            ...
            if ($stmtCheck->fetchColumn() > 0) {
                ...
                // CORREÇÃO AQUI: Ajustado os campos para a estrutura real da tabela (senha_hash, perfil, ativo)
                $sql = "INSERT INTO usuarios (nome, email, senha_hash, perfil, ativo) VALUES (?, ?, ?, 'Solicitante', 1)";
...
<head>
    ...
    <style>
        ...
        .btn-primary-mod { background: var(--primary-purple); color: white; border: none; border-radius: 12px; padding: 12px 25px; font-weight: 600; transition: 0.3s; }
        ...
        .form-control:focus { border-color: var(--primary-purple); box-shadow: 0 0 0 0.25rem rgba(99, 102, 241, 0.25); }
    </style>
</head>
<body>
...
<main class="main-content">
    <div class="mb-5">
        <span class="text-muted small fw-bold">SGM / USUÁRIOS</span>
        <h2 class="fw-bold m-0">Adicionar Novo Usuário</h2>
    </div>
        ...
        <div class="col-lg-7">
            <div class="card card-form p-5">
                ...
                <form action="add_usuario.php" method="POST">
                    ...
                    <div class="mb-5">
                        <label class="form-label fw-semibold text-secondary">Senha de Acesso</label>
                        <input type="password" name="senha" class="form-control" placeholder="••••••••" required>
                    </div>

                    <button type="submit" class="btn-primary-mod w-100"><i class="bi bi-person-plus-fill me-2"></i>Cadastrar Usuário</button>
                </form>
